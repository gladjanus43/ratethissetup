    ...
    <div class="container col-6 offset-3">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-setups" role="tab"
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade" id="nav-setups" role="tabpanel" aria-labelledby="nav-setups-tab">
                                ...
                                <form class="mt-2" action="/setupActive" method="post">
                                    ...
                                    <div class="d-flex justify-content-center mb-2">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="isActive" value="1" @if($setup->is_active == true)checked="true" @endif>
                                            <label class="form-check-label">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="isActive" value="0" @if($setup->is_active == false)checked="true" @endif>
